		...
		<App header footer>
			<main class="flex-1 w-full flex flex-col justify-start items-start px-3">
				<div class="w-full flex flex-col justify-center items-start mt-3">
					<div class="flex">
						<span class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl hover:text-black duration-200 font-montserrat font-semibold text-center pr-2">Tanishq</span>
						<span class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl hover:text-black duration-200 font-montserrat font-thin text-center">Singh</span>
					</div>
